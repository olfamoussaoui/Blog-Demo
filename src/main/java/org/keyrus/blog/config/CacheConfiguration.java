package org.keyrus.blog.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.keyrus.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.keyrus.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
